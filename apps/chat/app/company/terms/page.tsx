...
export default function Terms() {
  const markdown = `
## Upstreet Terms of Service

### 1. Introduction

Welcome to Upstreet Corporation ("Upstreet," "we," "our," "us"). 

These Terms of Service ("TOS") govern your use of our AI agent service. By accessing or using our services, you agree to comply with and be bound by these TOS.
