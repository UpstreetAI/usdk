...
Module.locateFile = function(url) {
    if (url == "libopusjs/libopus.wasm" && typeof LIBOPUS_WASM_URL !== "undefined") return LIBOPUS_WASM_URL;
    else return url
};
var moduleOverrides = {};
var key;
...
console.log("ENVIRONMENT_IS_SHELL: ",ENVIRONMENT_IS_WEB)
...
var wasmBinaryFile = "libopusjs/libopus.wasm";
...
function createWasm() {
    ...
    async function instantiateStaticWasm (wasmFile, info) {
        try {
            // console.log("wasmFile", wasmFile)
            var output = await WebAssembly.instantiate(wasmFile, info);
            // console.log("output: ", output.exports);
            receiveInstance(output);
        }
        catch (err) {
            console.error("[instantiateStaticWasm]", err)
        }
    }
    ...
    function instantiateAsync() {
        if (!wasmBinary && typeof WebAssembly.instantiateStreaming === "function" && !isDataURI(wasmBinaryFile) && !isFileURI(wasmBinaryFile) && typeof fetch === "function") {
            fetch(wasmBinaryFile, {
                ...
                console.log("instantiateAsync result: ",result);
    ...
    // console.warn("opusWasm: ",opusWasm);
    // wasmBinaryFile = opusWasm;
    instantiateAsync();
    // instantiateStaticWasm(opusWasm, info);
    return {}
}
var tempDouble;
var tempI64;
...
var _Encoder_new = Module._Encoder_new = function() {
    return (_Encoder_new = Module._Encoder_new = Module.asm.p).apply(null, arguments)
};
var _Encoder_delete = Module._Encoder_delete = function() {
    return (_Encoder_delete = Module._Encoder_delete = Module.asm.q).apply(null, arguments)
};
var _Encoder_input = Module._Encoder_input = function() {
    return (_Encoder_input = Module._Encoder_input = Module.asm.r).apply(null, arguments)
};
var _Encoder_output = Module._Encoder_output = function() {
    return (_Encoder_output = Module._Encoder_output = Module.asm.s).apply(null, arguments)
};
var _Decoder_new = Module._Decoder_new = function() {
    return (_Decoder_new = Module._Decoder_new = Module.asm.t).apply(null, arguments)
};
...
var _Decoder_input = Module._Decoder_input = function() {
    return (_Decoder_input = Module._Decoder_input = Module.asm.v).apply(null, arguments)
};
var _Decoder_output = Module._Decoder_output = function() {
    return (_Decoder_output = Module._Decoder_output = Module.asm.w).apply(null, arguments)
};
var _String_size = Module._String_size = function() {
    return (_String_size = Module._String_size = Module.asm.x).apply(null, arguments)
};
var _String_new = Module._String_new = function() {
    return (_String_new = Module._String_new = Module.asm.y).apply(null, arguments)
};
var _String_data = Module._String_data = function() {
    return (_String_data = Module._String_data = Module.asm.z).apply(null, arguments)
};
var _String_delete = Module._String_delete = function() {
    return (_String_delete = Module._String_delete = Module.asm.A).apply(null, arguments)
};
var _Int16Array_size = Module._Int16Array_size = function() {
    return (_Int16Array_size = Module._Int16Array_size = Module.asm.B).apply(null, arguments)
};
var _Int16Array_new = Module._Int16Array_new = function() {
    return (_Int16Array_new = Module._Int16Array_new = Module.asm.C).apply(null, arguments)
};
var _Int16Array_data = Module._Int16Array_data = function() {
    return (_Int16Array_data = Module._Int16Array_data = Module.asm.D).apply(null, arguments)
};
var _Int16Array_delete = Module._Int16Array_delete = function() {
    return (_Int16Array_delete = Module._Int16Array_delete = Module.asm.E).apply(null, arguments)
};
...
libopus.waitForReady = () => p;
libopus.onRuntimeInitialized = () => {
    accept();
};
export default libopus;