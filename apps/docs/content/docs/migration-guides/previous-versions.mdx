...
For example, if your Agent was created with USDK version **0.0.80**, and you want it to update to **{pkgJson.version}**, you should first [update USDK itself](#updating-usdk) to that particular version, and then running the above command.
