...
description: This section describes how to build a Discord Bot  named "Nimbus" with the help of Upstreet Agent and Discord tokens
full: false
---

The source code for this example is available on Github (uploading soon):

## Video Tutorial

You can follow along this example by watching the video (uploading soon):
...
Now it will ask for a Discord token and channel you want the bot to join
...
<Callout>
This tutorial will **not** cover how to obtain discord tokens . For more information, you can refer to the [Discord Developer Portal ](https://discord.com/developers/docs/intro).
