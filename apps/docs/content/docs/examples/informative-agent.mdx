---
title: Informative Agent (Pokédex)
description: This section describes how to build a Pokédex Agent with Upstreet, by building custom Components.
full: false
---
...
You can see this code on GitHub [here](https://github.com/UpstreetAI/usdk-examples/blob/5d1e2299ff4a518c0791f8e3c8a49143eb1fecc2/pokedex/agent.tsx#L13).

### Step 4: Test out your Pokédex!

You can run `usdk chat` to test your Pokédex out. [Learn more](/test-your-agent)
