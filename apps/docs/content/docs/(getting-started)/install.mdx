...
NPM (Node Package Manager) is how you can download Node packages. It comes installed alongside NodeJS. 

**Not familiar with NodeJS or NPM?** Read the [prerequisites](#prerequisites).
...
This command should return the installed version number. You can view all available versions of `usdk` on [NPM](https://www.npmjs.com/package/usdk?activeTab=versions).
