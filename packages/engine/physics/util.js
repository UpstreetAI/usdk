    ...
    if (geometry.attributes.position.isInterleavedBufferAttribute) {
      ...
      for (
        ...
        localVector
          ...
          .toArray(positions, i);
        // positions[i] = geometry.attributes.position.data.array[j];
        // positions[i + 1] = geometry.attributes.position.data.array[j + 1];
        // positions[i + 2] = geometry.attributes.position.data.array[j + 2];
      }
