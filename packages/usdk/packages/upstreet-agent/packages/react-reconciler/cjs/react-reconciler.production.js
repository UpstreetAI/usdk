...
module.exports = function ($$$config) {
  ...
  function appendAllChildren(
    ...
    if (supportsMutation)
      ...
      for (var node$87 = workInProgress.child; null !== node$87; ) {
        if (5 === node$87.tag) {
          var instance = node$87.stateNode;
          needsVisibilityToggle &&
            isHidden &&
            (instance = cloneHiddenInstance(
              instance,
              node$87.type,
              node$87.memoizedProps
            ));
          appendInitialChild(parent, instance);
        } else if (6 === node$87.tag)
          (instance = node$87.stateNode),
            needsVisibilityToggle &&
              isHidden &&
            ...
            appendInitialChild(parent, instance);
        else if (4 !== node$87.tag)
          if (22 === node$87.tag && null !== node$87.memoizedState)
            (instance = node$87.child),
              null !== instance && (instance.return = node$87),
              appendAllChildren(parent, node$87, !0, !0);
          else if (null !== node$87.child) {
            node$87.child.return = node$87;
            node$87 = node$87.child;
            continue;
          }
        if (node$87 === workInProgress) break;
        for (; null === node$87.sibling; ) {
          if (null === node$87.return || node$87.return === workInProgress)
            return;
          node$87 = node$87.return;
        }
        node$87.sibling.return = node$87.return;
        node$87 = node$87.sibling;
      }
  }
      ...
      if (
        ...
        oldProps$90 === currentInstance
          ...
          : (finalizeInitialChildren(
            ...
            (workInProgress.stateNode = oldProps$90),
            current
              ? appendAllChildren(oldProps$90, workInProgress, !1, !1)
              : markUpdate(workInProgress));
    ...
    switch (workInProgress.tag) {
      ...
      case 13:
        ...
        if (renderLanes) {
          ...
          cache$106 !== nextResource && (newProps.flags |= 2048);
        }
        renderLanes !== current &&
          renderLanes &&
      ...
      case 19:
        ...
        cache$106 = nextResource.rendering;
        if (null === cache$106)
          ...
          a: if (((current = null), supportsMutation))
            for (root = finishedWork; ; ) {
              if (
                ...
                if (null === current)
                  try {
                    var instance$123 = root.stateNode;
                    hoistableRoot
                      ? hideTextInstance(instance$123)
                      : unhideTextInstance(instance$123, root.memoizedProps);
                  } catch (error$124) {
                    captureCommitPhaseError(
                      finishedWork,
                      finishedWork.return,
